...
| 场景 | 线程 | QPS | 延迟 | CPU | 合并率 | 带宽 | vs RANDOM |
|------|------|-----|------|-----|--------|------|-----------|
| SAME_VERSION | 1000 | **25,310** | 38ms | 26.9% | 80.2% | 308 MB/s | **2.77x** |
| CLOSE_VERSIONS | 1000 | 25,413 | 38ms | 26.2% | 80.2% | 309 MB/s | 2.78x |
| BOUNDARY_GAP | 1000 | 25,049 | 38ms | 27.4% | 80.1% | 305 MB/s | 2.74x |
| HOTSPOT_MIX | 1000 | 18,065 | 53ms | 92.6% | 52.4% | 818 MB/s | 1.98x |
| RANDOM | 1000 | 9,141 | 103ms | 95.0% | 8.1% | 935 MB/s | baseline |

**关键结论**:
- 高合并率场景 (SAME_VERSION) QPS 提升 **177%**，延迟降低 **63%**
- CPU 使用率从 95% 降至 27%，有更大的扩展空间
- 网络带宽从 935 MB/s 降至 308 MB/s，减少 **67%**
