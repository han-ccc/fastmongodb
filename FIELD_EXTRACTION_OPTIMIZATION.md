...
| 操作 | 基线 | 阶段2后 | 改进 |
|-----|------|---------|------|
| 简单表INSERT(单条) | 239us | 238us | **-0.4%** |
| 复杂表INSERT(单条) | 377us | 319us | **-15.4%** |
| 简单表INSERT(批量10) | 294us | 296us | +0.7% |
| 复杂表INSERT(批量10) | 1470us | 1222us | **-16.9%** |
| 复杂表UPDATE(非索引) | 270us | 265us | **-1.9%** |
| 复杂表UPDATE(索引字段) | 348us | 302us | **-13.2%** |
| 简单表DELETE | 241us | 253us | +5.0% |
| 复杂表DELETE | 310us | 281us | **-9.4%** |
| 简单表POINT QUERY | 217us | 235us | +8.3% |
| 复杂表POINT QUERY | 247us | 236us | **-4.5%** |
...
**注**: 阶段1+2优化主要针对字段提取路径，对复杂表（多索引、嵌套字段）效果显著。
